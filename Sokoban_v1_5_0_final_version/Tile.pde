class Tile {                
  ...
  //default constructor and initialise all values to 0
  Tile() {
   xPosition = 0;
   yPosition = 0;         
  ...
  //takes string argument from checkCollision method to determine side of impact
...
//returns side of impact for tile object (player on crate, crate on walls)
  String getCollisionDirection() {
    return side;
  }

 //setter for updating player position once moved
