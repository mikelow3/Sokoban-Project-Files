...
*/
  ...
  void checkBoundaries() {
    if (xPosition + tileWidth > board1.getboardWidth()) {
      xPosition = board1.getboardWidth()-tileWidth;
    }
    if (xPosition < board1.boardXpos()) {
      xPosition = board1.boardXpos();
    }
    if (yPosition + tileHeight > board1.getboardHeight()) {
      yPosition = board1.getboardHeight()-tileHeight;
    }
    if (yPosition < board1.boardYpos()) {
      yPosition = board1.boardYpos();
    }
  }
